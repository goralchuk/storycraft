...
The shared visual design system and navigation shell — design tokens, decorative backdrop, and the navbar (with live coin balance) — that wrap authenticated screens and are hidden on pre-auth screens.
